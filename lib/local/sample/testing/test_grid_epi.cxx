/*=========================================================================
  ...
  Program:  sampsim
  Module:   test_sample_grid_epi.cxx
  Language: C++

=========================================================================*/
//
// .SECTION Description
// Unit tests for the sample::grid_epi class
//

#include "UnitTest++.h"

#include "grid_epi_sample.h"
#include "building.h"
#include "common.h"
#include "household.h"
...
TEST( test_sample_grid_epi )
{
  ...
  sampsim::sample::grid_epi *sample1 = new sampsim::sample::grid_epi;
  ...
  sampsim::sample::grid_epi *sample2 = new sampsim::sample::grid_epi;
  ...
  sample1->set_number_of_squares( 10 );
  ...
  for( unsigned int iteration = 0; iteration < 10; iteration++ )
  {
    ...
    sample->set_number_of_squares( 10 );
    ...
    cout << "Testing " << sample->get_number_of_squares() << " by " << sample->get_number_of_squares()
         << " grid..." << endl;
  ...
  population->unselect();
  sampsim::sample::grid_epi *sample3 = new sampsim::sample::grid_epi;
  ...
  sample3->set_number_of_squares( 10 );
  sample3->set_age( age );
  sample3->set_sex( sex );
  ...
  population->unselect();
  sampsim::sample::grid_epi *sample4 = new sampsim::sample::grid_epi;
  ...
  sample4->set_number_of_squares( 10 );
  sample4->set_age( age );
  sample4->set_sex( sex );
  ...
  population->unselect();
  sampsim::sample::grid_epi *sample5 = new sampsim::sample::grid_epi;
  ...
  sample5->set_number_of_squares( 10 );
