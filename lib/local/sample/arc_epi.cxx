...
{
  //-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-+#+-
  std::list< building* >::iterator arc_epi::select_next_building( std::list< building* > &list )
  {
      ...
      while( 0 == initial_buildings.size() && iterations < 100 )
      {
        ...
        for( auto it = list.begin(); it != list.end(); ++it )
        {
          ...
          if( M_PI < a2 )
          {
            ...
            if( ( a1 <= a && a <= M_PI ) || ( -M_PI <= a && a < a2 ) ) initial_buildings.push_back( it );
          }
          ...
          else
          {
            ...
            if( a1 <= a && a < a2 ) initial_buildings.push_back( it );
          }
        }
