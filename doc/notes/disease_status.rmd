...
However, it is possible to change the resulting mean by setting a parameter, $\tau$ (target
disease prevalence) to a number in (0,1).  This changes the value of $\eta$ to
the following:
