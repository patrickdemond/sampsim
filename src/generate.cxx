...
//  sampsim::sample::strip_epi *strip_epi_sample = new sampsim::sample::strip_epi;
  ...
  opts.add_heading( "" );
  opts.add_option( "mean_income_b00", "1", "Mean income trend's independent coefficient base value" );
  opts.add_option( "mean_income_b01", "0", "Mean income trend's X coefficient base value" );
  opts.add_option( "mean_income_b10", "0", "Mean income trend's Y coefficient base value" );
  opts.add_option( "mean_income_b02", "0", "Mean income trend's X^2 coefficient base value" );
  opts.add_option( "mean_income_b20", "0", "Mean income trend's Y^2 coefficient base value" );
  opts.add_option( "mean_income_b11", "0", "Mean income trend's XY coefficient base value" );
  opts.add_option( "sd_income_b00", "1", "SD income trend's independent coefficient base value" );
  opts.add_option( "sd_income_b01", "0", "SD income trend's X coefficient base value" );
  opts.add_option( "sd_income_b10", "0", "SD income trend's Y coefficient base value" );
  opts.add_option( "sd_income_b02", "0", "SD income trend's X^2 coefficient base value" );
  opts.add_option( "sd_income_b20", "0", "SD income trend's Y^2 coefficient base value" );
  opts.add_option( "sd_income_b11", "0", "SD income trend's XY coefficient base value" );
  opts.add_option( "mean_disease_b00", "1", "Mean disease trend's independent coefficient base value" );
  opts.add_option( "mean_disease_b01", "0", "Mean disease trend's X coefficient base value" );
  opts.add_option( "mean_disease_b10", "0", "Mean disease trend's Y coefficient base value" );
  opts.add_option( "mean_disease_b02", "0", "Mean disease trend's X^2 coefficient base value" );
  opts.add_option( "mean_disease_b20", "0", "Mean disease trend's Y^2 coefficient base value" );
  opts.add_option( "mean_disease_b11", "0", "Mean disease trend's XY coefficient base value" );
  opts.add_option( "sd_disease_b00", "1", "SD disease trend's independent coefficient base value" );
  opts.add_option( "sd_disease_b01", "0", "SD disease trend's X coefficient base value" );
  opts.add_option( "sd_disease_b10", "0", "SD disease trend's Y coefficient base value" );
  opts.add_option( "sd_disease_b02", "0", "SD disease trend's X^2 coefficient base value" );
  opts.add_option( "sd_disease_b20", "0", "SD disease trend's Y^2 coefficient base value" );
  opts.add_option( "sd_disease_b11", "0", "SD disease trend's XY coefficient base value" );
  opts.add_option( "popdens_b00", "1", "Population density trend's independent coefficient base value" );
  opts.add_option( "popdens_b01", "0", "Population density trend's X coefficient base value" );
  opts.add_option( "popdens_b10", "0", "Population density trend's Y coefficient base value" );
  opts.add_option( "popdens_b02", "0", "Population density trend's X^2 coefficient base value" );
  opts.add_option( "popdens_b20", "0", "Population density trend's Y^2 coefficient base value" );
  opts.add_option( "popdens_b11", "0", "Population density trend's XY coefficient base value" );
