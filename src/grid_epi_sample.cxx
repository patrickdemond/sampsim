/*=========================================================================
  ...
  Program:  sampsim
  Module:   grid_epi_sample.cxx
  Language: C++

=========================================================================*/
//
// .SECTION Description
// An executable which samples a population using the grid EPI method
//
...
int main( const int argc, const char** argv )
{
  ...
  try
  {
    ...
    if( opts.process() )
    {
      ...
      {
        parse_grid_epi_sample( opts, sample );
