...
enum_sample="$build_dir/enumeration_sample"
grid_epi_sample="$build_dir/grid_epi_sample"
peri_epi_sample="$build_dir/strip_epi_sample"
qtr_epi_sample="$build_dir/strip_epi_sample"
